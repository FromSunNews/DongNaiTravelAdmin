            ...
            <Accordion as="ul" className="navbar-nav iq-main-menu">
                <li className="nav-item static-item">
                    <Link className="nav-link static-item disabled" to="#" tabIndex="-1">
                        <span className="default-icon">TRANG CHỦ</span>
                        <span className="mini-icon">-</span>
                    </Link>
                </li>

                {/* Tổng quan */}
                <SidebarMenu isTag="true" pathname='/' title='Tổng quan'>
                    <i className="icon">
                ...
                <Accordion.Item as="li" eventKey="places" bsPrefix={`nav-item ${active === 'places' ? 'active' : ''} `} onClick={() => setActive('places')} >
                    ...
                    <Accordion.Collapse eventKey="places" >
                        ...
                        <SidebarMenu isTag="false" staticIcon='true' minititle='TK' pathname='/places/statistic' title='Thống kê Địa Điểm' ></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon='true' minititle='T' pathname='/places/create' title='Tạo Địa Điểm' ></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon='true' minititle='CT' pathname='/places/content' title='Tạo Nội Dung' ></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon='true' minititle='D' pathname='/places/report' title='Báo Cáo Địa Điểm' ></SidebarMenu>
                        </ul>
                    </Accordion.Collapse>
                </Accordion.Item>

                {/* Blog */}
                <Accordion.Item as="li" eventKey="blogs" bsPrefix={`nav-item ${active === 'blogs' ? 'active' : ''} `} onClick={() => setActive('blogs')} >
                    <CustomToggle eventKey="blogs" onClick={(activeKey) => setActiveMenu(activeKey)}>
                        ...
                        <span className="item-name" style={{paddingRight: "7px !important"}}>Blog</span>
                        <i className="right-icon">
                            <svg className="icon-18" xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                            </svg>
                    ...
                    <Accordion.Collapse eventKey="blogs" >
                        <ul className="sub-nav">
                            <SidebarMenu isTag="false" staticIcon='true' minititle='TK' pathname='/blogs/statistic' title='Thống kê Blog' ></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon='true' minititle='T' pathname='/blogs/create' title='Tạo Blog' ></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon='true' minititle='BC' pathname='/blogs/report' title='Báo Cáo Blog' ></SidebarMenu>
                            {/* <SidebarMenu isTag="false" staticIcon='true' minititle='CT' pathname='/blogs/detail' title='Báo Cáo Chi Tiết' ></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon='true' minititle='TH' pathname='/blogs/synthesis' title='Báo Cáo Tổng Hợp' ></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon='true' minititle='CG' pathname='/blogs/unsent' title='Báo Cáo Chưa Gửi' ></SidebarMenu> */}
                        </ul>
                    </Accordion.Collapse>
                </Accordion.Item>

                {/* Silders */}
                <Accordion.Item as="li" eventKey="sliders" bsPrefix={`nav-item ${active === 'sliders' ? 'active' : ''} `} onClick={() => setActive('sliders')} >
                    <CustomToggle eventKey="sliders" onClick={(activeKey) => setActiveMenu(activeKey)}>
                        <OverlayTrigger placement="right" overlay={<Tooltip>Sliders</Tooltip>}>
                            <i className="icon">
                                <svg width="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="icon-24" height="32"><path d="M21.9999 14.7024V16.0859C21.9999 16.3155 21.9899 16.5471 21.9699 16.7767C21.6893 19.9357 19.4949 22 16.3286 22H7.67126C6.06806 22 4.71535 21.4797 3.74341 20.5363C3.36265 20.1864 3.042 19.7753 2.7915 19.3041C3.12217 18.9021 3.49291 18.462 3.85363 18.0208C4.46485 17.289 5.05603 16.5661 5.42677 16.0959C5.97788 15.4142 7.43078 13.6196 9.44481 14.4617C9.85563 14.6322 10.2164 14.8728 10.547 15.0833C11.3586 15.6247 11.6993 15.7851 12.2705 15.4743C12.9017 15.1335 13.3125 14.4617 13.7434 13.76C13.9739 13.388 14.2043 13.0281 14.4548 12.6972C15.547 11.2736 17.2304 10.8926 18.6332 11.7348C19.3346 12.1559 19.9358 12.6872 20.4969 13.2276C20.6172 13.3479 20.7374 13.4592 20.8476 13.5695C20.9979 13.7198 21.4989 14.2211 21.9999 14.7024Z" fill="currentColor"></path><path opacity="0.4" d="M16.3387 2H7.67134C4.27455 2 2 4.37607 2 7.91411V16.086C2 17.3181 2.28056 18.4119 2.79158 19.3042C3.12224 18.9022 3.49299 18.4621 3.85371 18.0199C4.46493 17.2891 5.05611 16.5662 5.42685 16.096C5.97796 15.4143 7.43086 13.6197 9.44489 14.4618C9.85571 14.6323 10.2164 14.8729 10.5471 15.0834C11.3587 15.6248 11.6994 15.7852 12.2705 15.4734C12.9018 15.1336 13.3126 14.4618 13.7435 13.759C13.9739 13.3881 14.2044 13.0282 14.4549 12.6973C15.5471 11.2737 17.2305 10.8927 18.6333 11.7349C19.3347 12.1559 19.9359 12.6873 20.497 13.2277C20.6172 13.348 20.7375 13.4593 20.8477 13.5696C20.998 13.7189 21.499 14.2202 22 14.7025V7.91411C22 4.37607 19.7255 2 16.3387 2Z" fill="currentColor"></path><path d="M11.4543 8.79668C11.4543 10.2053 10.2809 11.3783 8.87313 11.3783C7.46632 11.3783 6.29297 10.2053 6.29297 8.79668C6.29297 7.38909 7.46632 6.21509 8.87313 6.21509C10.2809 6.21509 11.4543 7.38909 11.4543 8.79668Z" fill="currentColor"></path></svg>
                            </i>
                        </OverlayTrigger>
                        <span className="item-name" style={{paddingRight: "7px !important"}}>Sliders</span>
                        <i className="right-icon">
                            <svg className="icon-18" xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                            </svg>
                    ...
                    <Accordion.Collapse eventKey="sliders" >
                        <ul className="sub-nav">
                            <SidebarMenu isTag="false" staticIcon='true' minititle='D' pathname='/sliders/statistic' title='Thống kê Slider' ></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon='true' minititle='T' pathname='/sliders/create' title='Tạo Silder' ></SidebarMenu>
                        </ul>
                    </Accordion.Collapse>
                </Accordion.Item>

                {/* Người Dùng */}
                <Accordion.Item as="li" eventKey="users" bsPrefix={`nav-item ${active === 'users' ? 'active' : ''} `} onClick={() => setActive('users')} >
                    <CustomToggle eventKey="users" onClick={(activeKey) => setActiveMenu(activeKey)}>
                        <OverlayTrigger placement="right" overlay={<Tooltip>Sliders</Tooltip>}>
                            <i className="icon">
                            <svg width="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="icon-24" height="32"><path d="M11.997 15.1746C7.684 15.1746 4 15.8546 4 18.5746C4 21.2956 7.661 21.9996 11.997 21.9996C16.31 21.9996 19.994 21.3206 19.994 18.5996C19.994 15.8786 16.334 15.1746 11.997 15.1746Z" fill="currentColor"></path><path opacity="0.4" d="M11.9971 12.5838C14.9351 12.5838 17.2891 10.2288 17.2891 7.29176C17.2891 4.35476 14.9351 1.99976 11.9971 1.99976C9.06008 1.99976 6.70508 4.35476 6.70508 7.29176C6.70508 10.2288 9.06008 12.5838 11.9971 12.5838Z" fill="currentColor"></path></svg>
                            </i>
                        </OverlayTrigger>
                        <span className="item-name" style={{paddingRight: "7px !important"}}>Người Dùng</span>
                        <i className="right-icon">
                            <svg className="icon-18" xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                            </svg>
                    ...
                    <Accordion.Collapse eventKey="users" >
                        <ul className="sub-nav">
                            <SidebarMenu isTag="false" staticIcon='true' minititle='TK' pathname='/users/statistic' title='Thống kê Người Dùng' ></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon='true' minititle='T' pathname='/users/create' title='Tạo Người Dùng Mới' ></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon='true' minititle='BC' pathname='/users/report' title='Báo Cáo Người Dùng' ></SidebarMenu>
                        </ul>
                    </Accordion.Collapse>
                </Accordion.Item>

                {/* Sự Kiện */}
                <Accordion.Item as="li" eventKey="events" bsPrefix={`nav-item ${active === 'events' ? 'active' : ''} `} onClick={() => setActive('events')} >
                    <CustomToggle eventKey="events" onClick={(activeKey) => setActiveMenu(activeKey)}>
                        <OverlayTrigger placement="right" overlay={<Tooltip>Sliders</Tooltip>}>
                            <i className="icon">
                                <svg width="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="icon-24" height="32"><path opacity="0.4" d="M21.25 13.4764C20.429 13.4764 19.761 12.8145 19.761 12.001C19.761 11.1865 20.429 10.5246 21.25 10.5246C21.449 10.5246 21.64 10.4463 21.78 10.3076C21.921 10.1679 22 9.97864 22 9.78146L21.999 7.10415C21.999 4.84102 20.14 3 17.856 3H6.144C3.86 3 2.001 4.84102 2.001 7.10415L2 9.86766C2 10.0648 2.079 10.2541 2.22 10.3938C2.36 10.5325 2.551 10.6108 2.75 10.6108C3.599 10.6108 4.239 11.2083 4.239 12.001C4.239 12.8145 3.571 13.4764 2.75 13.4764C2.336 13.4764 2 13.8093 2 14.2195V16.8949C2 19.158 3.858 21 6.143 21H17.857C20.142 21 22 19.158 22 16.8949V14.2195C22 13.8093 21.664 13.4764 21.25 13.4764Z" fill="currentColor"></path><path d="M15.4303 11.5887L14.2513 12.7367L14.5303 14.3597C14.5783 14.6407 14.4653 14.9177 14.2343 15.0837C14.0053 15.2517 13.7063 15.2727 13.4543 15.1387L11.9993 14.3737L10.5413 15.1397C10.4333 15.1967 10.3153 15.2267 10.1983 15.2267C10.0453 15.2267 9.89434 15.1787 9.76434 15.0847C9.53434 14.9177 9.42134 14.6407 9.46934 14.3597L9.74734 12.7367L8.56834 11.5887C8.36434 11.3907 8.29334 11.0997 8.38134 10.8287C8.47034 10.5587 8.70034 10.3667 8.98134 10.3267L10.6073 10.0897L11.3363 8.61268C11.4633 8.35868 11.7173 8.20068 11.9993 8.20068H12.0013C12.2843 8.20168 12.5383 8.35968 12.6633 8.61368L13.3923 10.0897L15.0213 10.3277C15.2993 10.3667 15.5293 10.5587 15.6173 10.8287C15.7063 11.0997 15.6353 11.3907 15.4303 11.5887Z" fill="currentColor"></path></svg>
                            </i>
                        </OverlayTrigger>
                        <span className="item-name" style={{paddingRight: "7px !important"}}>Sự Kiện</span>
                        <i className="right-icon">
                            <svg className="icon-18" xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                            </svg>
                ...
                {/* <Accordion.Item as="li" eventKey="sidebar-social" bsPrefix={`nav-item ${active === 'social' ? 'active' : ''} `} onClick={() => setActive('social')} >
                    ...
                    <Accordion.Collapse eventKey="sidebar-social" >
                        <ul className="sub-nav">
                            ...
                            <SidebarMenu isTag="false" pathname='/social/newsfeed' title='Newsfeed' minititle='N'>
                                <i className="icon">
                                ...
                                <Accordion.Item as="li" eventKey="friend-list" bsPrefix={`nav-item ${location.pathname === '/social/friend-list' ? 'active' : '' || location.pathname === '/social/friend-requset' ? 'active' : '' || location.pathname === '/social/friend-profile' ? 'active' : ''}`}>
                                    ...
                                    <Accordion.Collapse eventKey="friend-list" >
                                        <ul className="sub-nav">
                                            ...
                                            <SidebarMenu isTag="false" staticIcon='true' minititle='FR' pathname='/social/friend-requset' title='Friend Request' ></SidebarMenu>
                ...
                <Accordion.Item as="li" eventKey="sidebar-blog" bsPrefix={`nav-item ${active === 'blog' ? 'active' : ''} `} onClick={() => setActive('blog')} >
                    ...
                    <Accordion.Collapse eventKey="sidebar-blog" >
                        <ul className="sub-nav">
                        <SidebarMenu isTag="false" minititle='D' pathname='/blog' title='Blog Dashboard'>
                            <i className="icon">
                                <svg className="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.4" d="M16.0756 2H19.4616C20.8639 2 22.0001 3.14585 22.0001 4.55996V7.97452C22.0001 9.38864 20.8639 10.5345 19.4616 10.5345H16.0756C14.6734 10.5345 13.5371 9.38864 13.5371 7.97452V4.55996C13.5371 3.14585 14.6734 2 16.0756 2Z" fill="currentColor"></path>
                                    <path fillRule="evenodd" clipRule="evenodd" d="M4.53852 2H7.92449C9.32676 2 10.463 3.14585 10.463 4.55996V7.97452C10.463 9.38864 9.32676 10.5345 7.92449 10.5345H4.53852C3.13626 10.5345 2 9.38864 2 7.97452V4.55996C2 3.14585 3.13626 2 4.53852 2ZM4.53852 13.4655H7.92449C9.32676 13.4655 10.463 14.6114 10.463 16.0255V19.44C10.463 20.8532 9.32676 22 7.92449 22H4.53852C3.13626 22 2 20.8532 2 19.44V16.0255C2 14.6114 3.13626 13.4655 4.53852 13.4655ZM19.4615 13.4655H16.0755C14.6732 13.4655 13.537 14.6114 13.537 16.0255V19.44C13.537 20.8532 14.6732 22 16.0755 22H19.4615C20.8637 22 22 20.8532 22 19.44V16.0255C22 14.6114 20.8637 13.4655 19.4615 13.4655Z" fill="currentColor"></path>
                            ...
                            <li className="nav-item ">
                                <Link className="nav-link" data-bs-toggle="collapse" to="#blog1" role="button" aria-expanded="false" aria-controls="blog">
                                    ...
                                    <span className="item-name">Blog</span>
                                    <i className="right-icon">
                                        <svg className="submit iocon-18" xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                                        </svg>
                                    </i>
                                </Link>
                ...
                <Accordion.Item as="li" eventKey="sidebar-appointment" bsPrefix={`nav-item ${active === 'appointment' ? 'active' : ''} `} onClick={() => setActive('appointment')} >
                    <CustomToggle eventKey="sidebar-appointment" onClick={(activeKey) => setActiveMenu(activeKey)}>
                ...
                <Accordion.Item as="li" eventKey="sidebar-file-manager" bsPrefix={`nav-item ${active === 'file-manager' ? 'active' : ''} `} onClick={() => setActive('file-manager')} >
                    <CustomToggle eventKey="sidebar-file-manager" onClick={(activeKey) => setActiveMenu(activeKey)}>
                ...
                <SidebarMenu isTag="true" pathname='/chat/chat' title='Chat'>
                    <i className="icon">
                        <svg className="icon-20" width="20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <Accordion.Item as="li" eventKey="sidebar-mail" bsPrefix={`nav-item ${active === 'mail' ? 'active' : ''} `} onClick={() => setActive('mail')} >
                    <CustomToggle eventKey="sidebar-mail" onClick={(activeKey) => setActiveMenu(activeKey)}>
                ...
                <Accordion.Item as="li" eventKey="sidebar-special" bsPrefix={`nav-item ${location.pathname === '/dashboard/special-pages/billing' ? 'active' : '' || location.pathname === '/dashboard/special-pages/calender' ? 'active' : '' || location.pathname === '/dashboard/special-pages/kanban' ? 'active' : '' || location.pathname === '/dashboard/special-pages/pricing' ? 'active' : ''} `} onClick={() => setActive('special')} >
                    ...
                    <Accordion.Collapse eventKey="sidebar-special" >
                        <ul className="sub-nav">
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/dashboard/special-pages/billing' title='Billing' minititle='B'></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/dashboard/special-pages/calender' title='Calender' minititle='C'></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/dashboard/special-pages/kanban' title='Kanban' minititle='K'></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/dashboard/special-pages/pricing' title='Pricing' minititle='P'></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/dashboard/special-pages/timeline' title='Timeline' minititle='T'></SidebarMenu>
                        </ul>
                    </Accordion.Collapse>
                </Accordion.Item>
                        ...
                        <Accordion as="ul" className="navbar-nav iq-main-menu sub-nav">
                            <Accordion.Item eventKey="auth" as="li" bsPrefix={`nav-item ${location.pathname === '/auth/sign-in' ? 'active' : '' || location.pathname === '/auth/sign-up' ? 'active' : '' || location.pathname === '/auth/confirm-mail' ? 'active' : '' || location.pathname === '/auth/lock-screen' ? 'active' : '' || location.pathname === '/auth/recoverpw' ? 'active' : ''}`}>
                                ...
                                <Accordion.Collapse eventKey="auth">
                                    <ul className="sub-nav">
                                    <SidebarMenu isTag="false" staticIcon="true" pathname='/default/auth/sign-in' title='Login' minititle='L'></SidebarMenu>
                                    <SidebarMenu isTag="false" staticIcon="true" pathname='/default/auth/sign-up' title='Register' minititle='R'></SidebarMenu>
                                    <SidebarMenu isTag="false" staticIcon="true" pathname='/default/auth/confirm-mail' title='Confirm Mail' minititle='CM'></SidebarMenu>
                                    <SidebarMenu isTag="false" staticIcon="true" pathname='/default/auth/lock-screen' title='Lock Screen' minititle='LS'></SidebarMenu>
                                    <SidebarMenu isTag="false" staticIcon="true" pathname='/default/auth/recoverpw' title='Recover password' minititle='RP'></SidebarMenu>
                                    </ul>
                                </Accordion.Collapse>
                            </Accordion.Item>
                            <Accordion.Item eventKey="animate" as="li" bsPrefix={`nav-item ${location.pathname === '/auth/sign-in' ? 'active' : '' || location.pathname === '/auth/sign-up' ? 'active' : '' || location.pathname === '/auth/email' ? 'active' : '' || location.pathname === '/auth/lock-screen' ? 'active' : '' || location.pathname === '/auth/reset-password' ? 'active' : '' || location.pathname === '/auth/account-deactivate' ? 'active' : ''}`}>
                                <CustomToggle eventKey="animate" onClick={(activeKey) => setActiveMenu(activeKey)} className="nav-link">
                                    <i className="icon">
                                        <svg width="20" className="icon-20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path opacity="0.4" d="M12.0865 22C11.9627 22 11.8388 21.9716 11.7271 21.9137L8.12599 20.0496C7.10415 19.5201 6.30481 18.9259 5.68063 18.2336C4.31449 16.7195 3.5544 14.776 3.54232 12.7599L3.50004 6.12426C3.495 5.35842 3.98931 4.67103 4.72826 4.41215L11.3405 2.10679C11.7331 1.96656 12.1711 1.9646 12.5707 2.09992L19.2081 4.32684C19.9511 4.57493 20.4535 5.25742 20.4575 6.02228L20.4998 12.6628C20.5129 14.676 19.779 16.6274 18.434 18.1581C17.8168 18.8602 17.0245 19.4632 16.0128 20.0025L12.4439 21.9088C12.3331 21.9686 12.2103 21.999 12.0865 22Z" fill="currentColor"></path>
                                            <path d="M11.3194 14.3209C11.1261 14.3219 10.9328 14.2523 10.7838 14.1091L8.86695 12.2656C8.57097 11.9793 8.56795 11.5145 8.86091 11.2262C9.15387 10.9369 9.63207 10.934 9.92906 11.2193L11.3083 12.5451L14.6758 9.22479C14.9698 8.93552 15.448 8.93258 15.744 9.21793C16.041 9.50426 16.044 9.97004 15.751 10.2574L11.8519 14.1022C11.7049 14.2474 11.5127 14.3199 11.3194 14.3209Z" fill="currentColor"></path>
                                ...
                                <Accordion.Collapse eventKey="animate">
                                    <ul className="sub-nav">
                                    <SidebarMenu isTag="false" staticIcon="true" pathname='/auth/sign-in' title='Sign In' minititle='SI'></SidebarMenu>
                                    <SidebarMenu isTag="false" staticIcon="true" pathname='/auth/sign-up' title='Sign Up' minititle='SU'></SidebarMenu>
                                    <SidebarMenu isTag="false" staticIcon="true" pathname='/auth/email' title='Email' minititle='E'></SidebarMenu>
                                    <SidebarMenu isTag="false" staticIcon="true" pathname='/auth/lock-screen' title='Lock Screen' minititle='LS'></SidebarMenu>
                                    <SidebarMenu isTag="false" staticIcon="true" pathname='/auth/reset-password' title='Reset Password' minititle='RP'></SidebarMenu>
                                    <SidebarMenu isTag="false" staticIcon="true" pathname='/auth/two-factor' title='Two Factor' minititle='TF'></SidebarMenu>
                                    <SidebarMenu isTag="false" staticIcon="true" pathname='/auth/account-deactivate' title='Account Deactivate' minititle='AD'></SidebarMenu>
                                    </ul>
                                </Accordion.Collapse>
                            </Accordion.Item>
                            <Accordion.Item as="li" eventKey="simple" bsPrefix={`nav-item ${location.pathname === '/auth/simple/sign-in' ? 'active' : '' || location.pathname === '/auth/simple/sign-up' ? 'active' : '' }`}>
                                <CustomToggle eventKey="simple" onClick={(activeKey) => setActiveMenu(activeKey)} className="nav-link">
                                    <i className="icon">
                                        <svg width="20" className="icon-20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path opacity="0.4" d="M12.0865 22C11.9627 22 11.8388 21.9716 11.7271 21.9137L8.12599 20.0496C7.10415 19.5201 6.30481 18.9259 5.68063 18.2336C4.31449 16.7195 3.5544 14.776 3.54232 12.7599L3.50004 6.12426C3.495 5.35842 3.98931 4.67103 4.72826 4.41215L11.3405 2.10679C11.7331 1.96656 12.1711 1.9646 12.5707 2.09992L19.2081 4.32684C19.9511 4.57493 20.4535 5.25742 20.4575 6.02228L20.4998 12.6628C20.5129 14.676 19.779 16.6274 18.434 18.1581C17.8168 18.8602 17.0245 19.4632 16.0128 20.0025L12.4439 21.9088C12.3331 21.9686 12.2103 21.999 12.0865 22Z" fill="currentColor"></path>
                                            <path d="M11.3194 14.3209C11.1261 14.3219 10.9328 14.2523 10.7838 14.1091L8.86695 12.2656C8.57097 11.9793 8.56795 11.5145 8.86091 11.2262C9.15387 10.9369 9.63207 10.934 9.92906 11.2193L11.3083 12.5451L14.6758 9.22479C14.9698 8.93552 15.448 8.93258 15.744 9.21793C16.041 9.50426 16.044 9.97004 15.751 10.2574L11.8519 14.1022C11.7049 14.2474 11.5127 14.3199 11.3194 14.3209Z" fill="currentColor"></path>
                            ...
                            <Accordion.Item as="li" eventKey="popup" bsPrefix="nav-item">
                                <CustomToggle eventKey="popup" onClick={(activeKey) => setActiveMenu(activeKey)} className="nav-link">
                                    <i className="icon">
                                        <svg width="20" className="icon-20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path opacity="0.4" d="M12.0865 22C11.9627 22 11.8388 21.9716 11.7271 21.9137L8.12599 20.0496C7.10415 19.5201 6.30481 18.9259 5.68063 18.2336C4.31449 16.7195 3.5544 14.776 3.54232 12.7599L3.50004 6.12426C3.495 5.35842 3.98931 4.67103 4.72826 4.41215L11.3405 2.10679C11.7331 1.96656 12.1711 1.9646 12.5707 2.09992L19.2081 4.32684C19.9511 4.57493 20.4535 5.25742 20.4575 6.02228L20.4998 12.6628C20.5129 14.676 19.779 16.6274 18.434 18.1581C17.8168 18.8602 17.0245 19.4632 16.0128 20.0025L12.4439 21.9088C12.3331 21.9686 12.2103 21.999 12.0865 22Z" fill="currentColor"></path>
                                            <path d="M11.3194 14.3209C11.1261 14.3219 10.9328 14.2523 10.7838 14.1091L8.86695 12.2656C8.57097 11.9793 8.56795 11.5145 8.86091 11.2262C9.15387 10.9369 9.63207 10.934 9.92906 11.2193L11.3083 12.5451L14.6758 9.22479C14.9698 8.93552 15.448 8.93258 15.744 9.21793C16.041 9.50426 16.044 9.97004 15.751 10.2574L11.8519 14.1022C11.7049 14.2474 11.5127 14.3199 11.3194 14.3209Z" fill="currentColor"></path>
                                ...
                                <Accordion.Collapse eventKey="popup">
                                    <ul className="sub-nav">
                                        <SidebarMenu isTag="false" staticIcon="true" title='Sign In' minititle='SI' modalopen={handleShow}></SidebarMenu>
                                        <SidebarMenu isTag="false" staticIcon="true" title='Sign Up' minititle='SU' modalopen={handleShow1}></SidebarMenu>
                                    </ul>
                                </Accordion.Collapse>
                            </Accordion.Item>
                        </Accordion>
                ...
                <Accordion.Item as="li" eventKey="sidebar-user" bsPrefix={`nav-item ${location.pathname === '/dashboard/app/user-profile' ? 'active' : '' || location.pathname === '/dashboard/app/user-add' ? 'active' : '' || location.pathname === '/dashboard/app/user-list' ? 'active' : ''} `} onClick={() => setActive('user')} >
                    ...
                    <Accordion.Collapse eventKey="sidebar-user">
                        <ul className="sub-nav">
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/dashboard/app/user-profile' title='User Profile' minititle='UP'></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/dashboard/app/user-add' title='Add User' minititle='AU'></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/dashboard/app/user-list' title='User List' minititle='UL'></SidebarMenu>
                        </ul>
                    </Accordion.Collapse>
                </Accordion.Item>
                <Accordion.Item as="li" eventKey="utilities-error" bsPrefix={`nav-item ${active === 'error' ? 'active' : ''} `} onClick={() => setActive('error')} >
                    ...
                    <Accordion.Collapse eventKey="utilities-error">
                        <ul className="sub-nav">
                        <SidebarMenu isTag="false" staticIcon="true" pathname='/errors/error404' title='Error 404' minititle='E'></SidebarMenu>
                        <SidebarMenu isTag="false" staticIcon="true" pathname='/errors/error500' title='Error 500' minititle='E'></SidebarMenu>
                        <SidebarMenu isTag="false" staticIcon="true" pathname='/errors/maintenance' title='Maintenance' minititle='M'></SidebarMenu>
                        </ul>
                    </Accordion.Collapse>
                </Accordion.Item>
                
                <Accordion.Item as="li" eventKey="plugins" bsPrefix={`nav-item ${active === 'pulgins' ? 'active' : ''} `} onClick={() => setActive('pulgins')} >
                    <CustomToggle eventKey="plugins" active={activeMenu === 'plugins' ? true : false} onClick={(activeKey) => setActiveMenu(activeKey)}>
                    ...
                    <Accordion.Collapse eventKey="plugins">
                        ...
                        <SidebarMenu isTag="false" staticIcon="true" pathname='/plugins/choise-js' title='Choice JS' minititle='CJ'></SidebarMenu>
                        <SidebarMenu isTag="false" staticIcon="true" pathname='/plugins/flatpickr' title='Flatpicker' minititle='F'></SidebarMenu>
                        ...
                        <SidebarMenu isTag="false" staticIcon="true" pathname='/plugins/image-copper' title='Image Cropper' minititle='IC'></SidebarMenu>
                        <SidebarMenu isTag="false" staticIcon="true" pathname='/plugins/loader' title='Loader' minititle='L'></SidebarMenu> 
                        <SidebarMenu isTag="false" staticIcon="true" pathname='/plugins/select2' title='Select2' minititle='S'></SidebarMenu> 
                ...
                <SidebarMenu isTag="true" pathname='/dashboard/admin/admin' title='Admin'>
                    <i className="icon">
                ...
                <SidebarMenu isTag="true" pathname='/plugins/ui-color' title='Ui Color'>
                    <i className="icon">
                        <svg width="20" className="icon-20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <Accordion.Item as="li" eventKey="sidebar-widget" bsPrefix={` ${location.pathname === '/dashboard/widget/widgetbasic' || location.pathname === '/dashboard/widget/widgetchart' || location.pathname === '/dashboard/widget/widgetcard' ? 'active' : '' || active === 'widget' ? 'active' : ''} nav-item`} onClick={() => setActive('widget')}>
                    ...
                    <Accordion.Collapse eventKey="sidebar-widget">
                        <ul className="sub-nav">
                        <SidebarMenu isTag="false" staticIcon="true" pathname='/dashboard/widget/widgetbasic' title='Widget Basic' minititle="WB"></SidebarMenu>
                        <SidebarMenu isTag="false" staticIcon="true" pathname='/dashboard/widget/widgetchart' title='Widget Chart' minititle="WC"></SidebarMenu>
                        <SidebarMenu isTag="false" staticIcon="true" pathname='/dashboard/widget/widgetcard' title='Widget Card' minititle="WC"></SidebarMenu>
                        </ul>
                    </Accordion.Collapse>
                </Accordion.Item>
                <Accordion.Item as="li" eventKey="sidebar-maps" bsPrefix={`nav-item ${active === 'maps' ? 'active' : ''} `} onClick={() => setActive('maps')} >
                    ...
                    <Accordion.Collapse eventKey="sidebar-maps">
                        <ul className="sub-nav">
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/dashboard/map/google' title='Google' minititle="G"></SidebarMenu>
                        </ul>
                    </Accordion.Collapse>
                </Accordion.Item>
                <Accordion.Item as="li" eventKey="sidebar-form" bsPrefix={`nav-item ${active === 'form' ? 'active' : ''} `} onClick={() => setActive('form')} >
                    ...
                    <Accordion.Collapse eventKey="sidebar-form" >
                        <ul className="sub-nav">
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/dashboard/form/form-element' title='Elements' minititle="E"></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/dashboard/form/form-wizard' title='Wizard' minititle="W"></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/dashboard/form/form-validation' title='Validation' minititle="V"></SidebarMenu>
                        </ul>
                    </Accordion.Collapse>
                </Accordion.Item>
                <Accordion.Item as="li" eventKey="sidebar-table" bsPrefix={`nav-item ${active === 'table' ? 'active' : ''} `} onClick={() => setActive('table')} >
                    ...
                    <Accordion.Collapse eventKey="sidebar-table">
                        <ul className="sub-nav">
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/dashboard/table/bootstrap-table' title='Bootstrap Table' minititle="BT"></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/dashboard/table/table-data' title='Data Table' minititle="DT"></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/dashboard/table/border-table' title='Border Table' minititle="BT"></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/dashboard/table/fancy-table' title='Fancy Table' minititle="FT"></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/dashboard/table/fixed-table' title='Fixed Table' minititle="FT"></SidebarMenu>
                        </ul>
                    </Accordion.Collapse>
                </Accordion.Item>
                <Accordion.Item as="li" eventKey="sidebar-icons" bsPrefix={`nav-item mb-5 ${active === 'icons' ? 'active' : ''} `} onClick={() => setActive('icons')} >
                    ...
                    <Accordion.Collapse eventKey="sidebar-icons">
                        <ul className="sub-nav">
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/dashboard/icon/solid' title='Solid' minititle="S"></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/dashboard/icon/outline' title='Outlined' minititle="O"></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/dashboard/icon/dual-tone' title='Outlined' minititle="D"></SidebarMenu>
                        </ul>
                    </Accordion.Collapse>
                </Accordion.Item> */}
            </Accordion>
