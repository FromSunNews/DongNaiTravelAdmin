                ...
                <Card className="iq-document-card">
                    <Tab.Container defaultActiveKey="first">
                        ...
                        <Tab.Pane eventKey="first" className="bd-heading-1 fade show " id="content-badge-prv" role="tabpanel" aria-labelledby="typo-output">
                            ...
                            <div className="bd-example">
                                <Badge pill bg="soft-primary">Primary</Badge>{' '}
                                <Badge pill bg="soft-secondary">Secondary</Badge>{' '}
                                <Badge pill bg="soft-success">Success</Badge>{' '}
                                <Badge pill bg="soft-danger">Danger</Badge>{' '}
                                <Badge pill bg="soft-warning">Warning</Badge>{' '}
                                <Badge pill bg="soft-info">Info</Badge>{' '}
                                <Badge pill bg="soft-light text-dark">Light</Badge>{' '}
                                <Badge pill bg="soft-dark">Dark</Badge>
                            </div>
                            <div className="bd-example">
                            ...
                            <div className="bd-example">
                                <span className="bg-soft-primary rounded iq-custom-badge">
                                    Primary
                                ...
                                <span className="bg-soft-secondary rounded iq-custom-badge">
                                    Secondary
                                ...
                                <span className="bg-soft-success rounded iq-custom-badge mt-1 mt-sm-0">
                                    Success
                                ...
                                <span className="bg-soft-warning rounded iq-custom-badge mt-1 mt-sm-0">
                                    Warning
                                ...
                                <span className="bg-soft-danger rounded iq-custom-badge mt-1 mt-sm-0">
                                    Danger
