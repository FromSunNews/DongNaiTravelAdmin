    ...
    return (
        <Fragment>
            <Accordion as="ul" className="navbar-nav iq-main-menu">
                ...
                <SidebarMenu isTag="true" pathname='/e-commerce/admin/admin-dashboard' title='Admin Dashboard' minititle='A'>
                    <i className="icon">
                ...
                <SidebarMenu isTag="true" pathname='/e-commerce/user/vendor-dashbord' title='Vendor Dashboard' minititle='VD'>
                    <i className="icon">
                ...
                <Accordion.Item as="li" bsPrefix={`nav-item  ${location.pathname === '/e-commerce/shop-main' || location.pathname === '/e-commerce/shop-left-filter' ? 'active' : '' || location.pathname === '/e-commerce/shop-right-filter' ? 'active' : '' || location.pathname === '/e-commerce/product-full-grid' ? 'active' : '' || location.pathname === '/e-commerce/product-list' ? 'active' : '' || location.pathname === '/e-commerce/categories-list' ? 'active' : '' || activeMenu === 'shop-main' ? 'active' : ''} `} >
                    ...
                    <ul className="sub-nav " >
                        <SidebarMenu isTag="false" staticIcon="true" pathname='/e-commerce/shop-main' title='Shop Main' minititle='SM'></SidebarMenu>
                        <SidebarMenu isTag="false" staticIcon="true" pathname='/e-commerce/shop-left-filter' title='Shop Left Filter' minititle='SL'></SidebarMenu>
                        <SidebarMenu isTag="false" staticIcon="true" pathname='/e-commerce/shop-right-filter' title='Shop Right Filter' minititle='SR'></SidebarMenu>
                        <SidebarMenu isTag="false" staticIcon="true" pathname='/e-commerce/product-full-grid' title='Product Grid View' minititle='PG'></SidebarMenu>
                        <SidebarMenu isTag="false" staticIcon="true" pathname='/e-commerce/product-list' title='Product List View' minititle='PL'></SidebarMenu>
                        <SidebarMenu isTag="false" staticIcon="true" pathname='/e-commerce/categories-list' title='Categories List' minititle='C'></SidebarMenu>
                    </ul>
                    </Accordion.Collapse>
                </Accordion.Item>
                <Accordion.Item as="li" eventKey="products" bsPrefix={`nav-item   ${location.pathname === '/e-commerce/product-details' ? 'active' : '' || location.pathname === '/e-commerce/product-details-3d' ? 'active' : '' || location.pathname === '/e-commerce/product-details-360' ? 'active' : '' || activeMenu === 'products' ? 'active' : ''}`}  >
                    ...
                    <ul className="sub-nav " >
                        <SidebarMenu isTag="false" staticIcon="true" pathname='/e-commerce/product-details' title='Product Details' minititle='P'></SidebarMenu>
                        <SidebarMenu isTag="false" staticIcon="true" pathname='/product-details-3d' title='3D Product Detail' minititle='3D'></SidebarMenu>
                        <SidebarMenu isTag="false" staticIcon="true" pathname='/e-commerce/product-details-360' title='360 Product Detail' minititle='P'></SidebarMenu>
                    </ul>
                    </Accordion.Collapse>
                </Accordion.Item>
                ...
                <SidebarMenu isTag="false" pathname='/e-commerce/app/user-profile' title='User Profile' minititle='UP'>
                    <i className="icon">
                        <svg className="icon-20" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <SidebarMenu isTag="false" pathname='/e-commerce/app/user-list' title='User List' minititle='UL'>
                    <i className="icon">
                        <svg className="icon-20" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
