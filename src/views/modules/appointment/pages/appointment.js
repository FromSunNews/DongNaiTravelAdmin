...
import { theme_color } from "../../../../redux/settings/settingsSlice";

const Appointment = memo(() => {
  
  useSelector(theme_color);
        ...
        <Col lg="8" md="6" sm="12">
          <Card>
            ...
            <Card.Body className="">
              <DataTable
                 id="eCommerce-admin"
                data={ApponitmentTable.data}
                columns={ApponitmentTable.columns}
                tableData='eCommerce-admin'
              />
            </Card.Body>
          </Card>
        </Col>
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <div className="d-flex profile-media align-items-top">
                ...
                <div className="ms-4">
                  <h6 className="mb-1 ">
                    Robert Fox - <span className="text-primary">Surgeon</span>
                  </h6>
