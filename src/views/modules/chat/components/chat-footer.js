            ...
            <div className="card-footer px-3 py-3 border-top rounded-0">
                <form>
                    <div className="input-group">
                        <input type="text" className="form-control chat-input" placeholder="Write a message" aria-label="Recipient's username" />
                        ...
                        <span className="input-group-text mgs-icon voice-icon">
                            <svg width="18" height="23" viewBox="0 0 18 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M9.00021 21.5V18.3391" stroke="currentcolor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
                                ...
                                <path d="M17 10.3006C17 14.7394 13.418 18.3383 9 18.3383C4.58093 18.3383 1 14.7394 1 10.3006" stroke="currentcolor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
                                <path d="M11.0689 6.25579H13.0585" stroke="currentcolor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
                                <path d="M10.0704 9.59344H13.0605" stroke="currentcolor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
                            </svg>
                        </span>
