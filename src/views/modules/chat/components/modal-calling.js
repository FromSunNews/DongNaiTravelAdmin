        ...
        <Fragment>
            <Modal show={props.show} onHide={props.handleClose}>
                ...
                <Modal.Body>
                    ...
                    <div className="d-flex justify-content-between align-items-center pt-3 pb-3 border-bottom">
                        <Form.Check.Label className="mb-0" htmlFor="call-003">Show Call Window When DongNaiTravel is in the background</Form.Check.Label>
                        <div className="form-check form-switch mb-0">
                            <Form.Check.Input type="checkbox" id="call-003" defaultChecked />
                        </div>
                    </div>
                    <div className="d-flex justify-content-between align-items-center pt-3">
                        <Form.Check.Label className="form-check-label mb-0" htmlFor="call-004">Only allow DongNaiTravel calls from contacts to ring on this device</Form.Check.Label>
                        <div className="form-check form-switch mb-0">
