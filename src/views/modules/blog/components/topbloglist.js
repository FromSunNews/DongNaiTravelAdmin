                    ...
                    <div className="d-flex align-items-center iq-incoming-blogs gap-3">
                        ...
                        <div className="d-flex flex-column justify-content-center">
                            ...
                            <OverlayTrigger overlay={<Tooltip>{props.blogsmall1}</Tooltip>}>
                                <Link to="/blog/blog-details"  className="text-body para-ellipsis-1 fs-6">{props.blogsmall1}</Link>
                            </OverlayTrigger>
                            <span> | </span>
                            <OverlayTrigger overlay={<Tooltip>{props.blogsmall2}</Tooltip>}>
                                <Link to="/blog/blog-details"  className="text-mute para-ellipsis-1 fs-6">{props.blogsmall2}</Link>
                            </OverlayTrigger>
                            </div>
