                ...
                <Card.Body className="card-thumbnail">
                    <div>
                        ...
                        <div className="d-flex gap-3">
                            <Link to="/blog/blog-details" className="iq-blog-adventure">Travel</Link><span > | </span>
                            <Link to="/blog/blog-details" className="iq-blog-adventure text-primary">Jenny Wilson</Link>
                        </div>
