                            ...
                            <div className="d-flex flex-column justify-content-center">
                                ...
                                <div className="d-flex mb-3 gap-2">
                                    <OverlayTrigger overlay={<Tooltip>{props.blogsData1}</Tooltip>}>
                                        <Link to="/blog/blog-details"  className="iq-blog-adventure para-ellipsis-1 short-1">{props.blogsData1}</Link>
                                    </OverlayTrigger>
                                    <span> | </span>
                                    <OverlayTrigger overlay={<Tooltip>{props.blogsData2}</Tooltip>}>
                                        <Link to="/blog/blog-details"  className="iq-blog-adventure para-ellipsis-1 short-1 text-primary">{props.blogsData2}</Link>
                                    </OverlayTrigger>
                                </div>
                                <div>
                                    <Link to="/blog/blog-details"  className="btn btn-primary" >Read More</Link>
                                </div>
                            </div>
                        </div>
                    </div>
