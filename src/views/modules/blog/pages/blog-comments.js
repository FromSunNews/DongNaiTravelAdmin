    ...
    columns: [
      {
        ...
        render: function (data, type) {
          return (
            '  <div class="d-flex align-items-center"> <img class="rounded img-fluid avatar-65 me-3" src=' +
            data.img +
            ' alt="" loading="lazy" /><div className="media-support-info"><h5 class="iq-sub-label">' +
            data.name +
            '</h5><p class="mb-0">' +
            data.email +
            "</p></div></div>"
      ...
      },
      {
        ...
        render: function (data) {
          return (
            '<div class="d-flex gap-3 justify-content-center"><a class="btn btn-primary btn-icon btn-sm rounded-pill" href="/blog/blog-category" role="button"><span class="btn-inner">' +
            data.actionadd +
            '</span></a><div class="d-flex gap-3 justify-content-center"><a class="btn btn-primary btn-icon btn-sm rounded-pill" href="/blog/blog-category" role="button"><span class="btn-inner">' +
            data.actionedit +
            '</span></a><div class="d-flex gap-3 justify-content-center"><a class="btn btn-primary btn-icon btn-sm rounded-pill" href="/blog/blog-category" role="button"><span class="btn-inner">' +
            data.actionremove +
            "</span></a>"
    ...
    <Fragment>
      ...
      <Card>
        <Card.Body className="px-0">
          <DataTable
            data={BlogCommentsTable.data}
            columns={BlogCommentsTable.columns}
          />
        </Card.Body>
      </Card>
    </Fragment>
