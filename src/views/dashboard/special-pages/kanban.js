...
const tasksList = [
    { _id: 1, name: 'Product List view Changes', status: "backlog" },
    { _id: 2, name: 'Notification Module Setting', status: "backlog" },
    { _id: 3, name: 'Product List view Changes', status: "backlog" },
    { _id: 4, name: 'Admin Panel Customization', status: "backlog" },
    { _id: 5, name: 'Add Multiple theme options', status: "new" },
    { _id: 6, name: 'Admin Panel Customization', status: "new" },
    { _id: 7, name: 'Create Sidebar in Dashboard', status: "wip" },
    { _id: 8, name: 'General Improvement Landing', status: "wip" },
    { _id: 9, name: 'Add Multiple theme options', status: "wip" },
    { _id: 10, name: 'Sidebar in Dashboard Themes', status: "review" },
    { _id: 11, name: 'Helpdesk in Dashboard Themes', status: "review" },
  ];
  
  const channels = ["backlog", "new", "wip", "review"];
  const labelsMap = {
    backlog: "Open Projects 05",
    new: "In Progress 02",
    wip: "Reviews 01",
    review: "Closed 03"
  };
                                        ...
                                        <div>
                                                ...
                                                <div className="btn btn-icon btn-soft-light me-2">
                                                    <div className="btn-inner">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" fill="none">
                                                            <g>
                                                            <g>
                                                            <path d="M17 3.99988L4.99998 3.99998C3.89542 3.99999 3 4.89542 3 5.99998V19C3 20.1046 3.89543 21 5 21H18C19.1046 21 20 20.1046 20 19V6.69039" stroke="currentColor" strokeLinecap="round"/>
                                                            <path d="M12 12L21 3" stroke="currentColor" strokeLinecap="round"/>
                                                            </g>
                                                            </g>
                                                        </svg>
                                                    </div>
                                            ...
                                            <div className="iq-media-group-1 d-flex align-items-center">
                                                <Link to="#" className="iq-media-1">
                                                    <div className="icon iq-icon-box-2 text-primary">AT</div>
                                                </Link>
                                                <Link to="#" className="iq-media-1">
                                                    <div className="icon iq-icon-box-2 text-warning">WT</div>
                                                </Link>
                                                <Link to="#" className="iq-media-1">
                                                    <div className="icon iq-icon-box-2 text-success">GT</div>
                                                </Link>
                                                <Link to="#" className="iq-media-1">
