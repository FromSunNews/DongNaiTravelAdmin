  ...
  columns: [
    {
      ...
      render: function (data) {
        return (
          '<img class="bg-soft-primary rounded img-fluid avatar-40 me-3" src=' +
          data +
          ' alt="profile"/>'
        );
      },
    ...
    },
    {
      ...
      render: function (data) {
        return (
          '<div class="flex align-items-center list-user-action"><a class="btn btn-sm btn-icon btn-success" data-toggle="tooltip" data-placement="top" title="" data-original-title="Add" to="#"><span class="btn-inner">' +
          data.iconadd +
          '</span></a> <a class="btn btn-sm btn-icon btn-warning" data-toggle="tooltip" data-placement="top" title="" data-original-title="Add" to="#"><span class="btn-inner">' +
          data.iconedit +
          '</span></a> <a class="btn btn-sm btn-icon btn-danger" data-toggle="tooltip" data-placement="top" title="" data-original-title="Add" to="#"><span class="btn-inner">' +
          data.iconremove +
          "</span></a> </div>"
        );
      },
